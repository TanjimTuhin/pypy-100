...
def calculated_score(cards):
    '''take a list of cards and return the score calculated from the the cards
        '''
...
def compare(user_score,computer_score):
    if user_score==computer_score:
        ...
        return 'user loses,User has busted'
    elif computer_score>21:
        return 'user wins,opponent has busted'
...
def play_again():  
    ...
    while not is_game_over:
        ...
        print(f'computer first card:{computer_cards[1]}')
    ...
    print(f"your final cards are{user_cards} and score is {user_score}")
    print(f"computer final cards are{computer_cards} and score is {computer_score}")
...
while input('Do you want to play this game again? "y" or "n" ')=='y':
    clear()
    play_again()